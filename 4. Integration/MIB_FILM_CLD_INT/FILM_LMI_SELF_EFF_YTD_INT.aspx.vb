...
Partial Class FILM_LMI_SELF_EFF_YTD_INT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim date_Param As DateTime = DateTime.Now.AddDays(-1)
        ...
        For i = 0 To 2
            ...
            For ii = 0 To 2
                ...
                PVIEW2061(Year_Month, FMMCCODE(ii), date_Param.Day.ToString()) 'NEED DBLINK
    ...
    Public Sub PVIEW2061(ByVal yearmonth As String, ByVal fmmccode As String, ByVal day As String)
        ...
        Using conn
            ...
            cmd.CommandText = "PSP_SELFEF_CALC_PVIEW2061_INT"
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandTimeout = 0
            cmd.Parameters().Clear()
            cmd.Parameters.Add("P_YEARMTH", SqlDbType.VarChar, 10, Data.ParameterDirection.Input).Value = yearmonth
